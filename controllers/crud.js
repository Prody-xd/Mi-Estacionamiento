...
exports.update = (req, res)=>{
    ...
    conexion.query('UPDATE cliente SET ? WHERE id = ?',[{nombres:nombres, apellidos:apellidos, rut_cliente:rut_cliente, edad:edad, direccion:direccion, comuna:comuna, banco_cliente:banco_cliente, tarjeta_de_credito:tarjeta_de_credito}, id_cliente], (error, results)=>{
        if(error){
            console.log(error);   
        }else{
            res.redirect('/');
